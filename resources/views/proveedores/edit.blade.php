          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('proveedores.update', $proveedor->id_proveedor) }}">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $proveedor->nombre) }}" class="form-control" required>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="sitio_web" value="{{ old('sitio_web', $proveedor->sitio_web) }}" class="form-control">
              </div>
